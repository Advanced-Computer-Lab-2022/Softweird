...
function MyProfile (){
 ...
 useEffect(() =>{
    ...
    return (
                    <>
                   { inst && !loading && user &&
                   <InstructorProfile.Provider value={{inst,gender, setProfile, setLoading,user,setUser, loading }}>
    ...
    <Typography sx={{ fontSize: "2rem"}} color="000" >
     {user.fName + " " + user.lName}
      ...
      <Typography sx={{ fontSize: "1.1rem"}} color="000" display="flex" alignItems={"end"}>
        ...
        { gender ? <FemaleOutlinedIcon sx={{fontSize:"2rem", marginRight:"0.5rem", color:"#BBD2B1"}}/>  : <MaleOutlinedIcon sx={{fontSize:"2rem", marginRight:"0.5rem", color:"#BBD2B1"}}/> } {inst.user.gender}
       
      </Typography>
      <Typography sx={{ fontSize: "1.1rem"}} color="000" display="flex" alignItems={"end"}>
      {inst.user.type==="corporate"  &&  <BusinessIcon sx={{fontSize:"2rem", marginRight:"0.5rem", color:"#BBD2B1"}}/>} {inst.company.name}
      </Typography>
      <BootstrapDialog
    onClose={handleClose}
