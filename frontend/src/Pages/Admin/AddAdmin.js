...
function AddAdmin() {
	...
	return (
		...
		<h6>Gender: </h6> <input name='Gender' type="radio" value="Male" onChange={onChange} />  Male 
	   ...
	   <h3> </h3>
			{/* AddAdmin Button */}
			<div className='form-group'>
				<button style={{marginTop:"11%"}} type='submit' className='btn btn-primary btn-block' onClick={handleAdmin}>
					Add 
				</button>
			</div>
                    </div>
