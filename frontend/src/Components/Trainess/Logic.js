 ...
 */
export async function createPdfFromHtml({value}) {
    try{
     
  const pdfProps = await createPdfProps(value);
 ...
 */
async function createPdfProps(value) {
  ...
  const canvas = await html2canvas(value, options);
